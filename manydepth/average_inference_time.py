...
def average_ingerence_time(args):
    ...
    inf_time_warmup_iter = 50 # change number of warmup iterations
    inf_time_calc_iter = 50 # change number of itterations that are used to calculate average inference time
    inf_time_sum = 0
    ...
    for i in range(inf_time_warmup_iter + inf_time_calc_iter):
        ...
        # info log
        if i == 0:
            print('warming up {} iterations ...'.format(inf_time_warmup_iter))
        elif i == inf_time_warmup_iter:
            print('averaging inference time for {} iterations ...'.format(inf_time_calc_iter))
